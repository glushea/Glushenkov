...
function updateRestaurantCards(city) {
  ...
  restaurantsForCity.forEach(restaurant => {
    ...
    image.src="https://res.cloudinary.com/dxsuizt1v/image/upload/v1715193146/glushea_Icon_Project_restaurant_jwnorj.webp";
  ...
  sitesForCity.forEach(restaurant => {
    ...
    const image = document.createElement('img');
    // image.src = restaurant.image;
    image.src="https://res.cloudinary.com/dxsuizt1v/image/upload/v1715193147/glushea_Icon_Project_place_zolwhl.webp";
    image.alt = restaurant.name;
    card.appendChild(image);
